...
Once github is installed, Rstudio  configure your local github version automatically or give a specific username using the code below.

```
library(usethis)
use_git_config(user.name = "Dane Joe", user.email = "jane@example.org")
```
...
file > New Project * and dont selecet Version Control*

What we want is a new folder that is also a github
repository. 

## Create the new repositoryin github
